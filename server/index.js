    ...
    exchangeCodeForAccessToken()
      ...
      function fetchAuth0AccessToken(userInfoResponse){
        ...
        const payload = {
          ...
          audience: 'https://${process.env.REACT_APP_AUTH0)DOMAIN}/api/v2'
        }
       return axios.post(`https://${process.env.REACT_APP_AUTH0_DOMAIN}/oauth/token`, payload);
      }

      function fetchAuth0AccessToken (auth0AccessTokenResponse){
        const options = {
          headers: {
      ...
      function fetchGitHubAccessToken(gitHubAccessTokenResponse){
